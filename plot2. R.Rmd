...
```{r}
png("C:/Users/sumim/OneDrive/ドキュメント/Coursera datascience/Exploratory Data Analysis/plot2.png", width = 480, height = 480)

data$Weekday <- weekdays(data$Datetime)

plot(data$Datetime, data$Global_active_power, type = "l", col = "black",
     xlab = "", ylab = "Global Active Power (kilowatts)",
     main = "Global Active Power over Time", xaxt = "n")
